function templatedownload(name, surname, product, link) {
...
function templateAlert(name, surname, email, product, transcode) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                ...
                                                <div
                                                    style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                   El usuario  ${name}  ${surname}  ${email}!<br></br>
                                                    Desea comprar nuestro videocurso ${product}. transaccion ${transcode}
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                ...
                                                <div
                                                    style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                    Hola  ${name}  ${surname} !<br></br>
                                                    En breve será enviado el link de descarga de su compra.
                                                </div>
